          ...
          <ul class="nav navbar-nav align-items-center ml-auto">
            <li class="nav-item dropdown dropdown-language"><a class="nav-link dropdown-toggle" id="dropdown-flag" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-us"></i><span class="selected-language">English</span></a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);" data-language="id"><i class="flag-icon flag-icon-id"></i> Indonesia</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list">
                  <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{ asset('vuexy/vuexy/app-assets/images/pages/eCommerce/1.png') }}" alt="donuts" width="62">
                  ...
                  <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{ asset('vuexy/vuexy/app-assets/images/pages/eCommerce/7.png') }}" alt="donuts" width="62">
                    <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                      <div class="media-heading">
                  ...
                  <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{ asset('vuexy/vuexy/app-assets/images/pages/eCommerce/2.png') }}" alt="donuts" width="62">
                    <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                      <div class="media-heading">
                  ...
                  <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{ asset('vuexy/vuexy/app-assets/images/pages/eCommerce/3.png') }}" alt="donuts" width="62">
                    <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                      <div class="media-heading">
                  ...
                  <div class="media align-items-center"><img class="d-block rounded mr-1" src="{{ asset('vuexy/vuexy/app-assets/images/pages/eCommerce/5.png') }}" alt="donuts" width="62">
                    <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                      <div class="media-heading">
                ...
                <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                    <div class="media d-flex align-items-start">
                      <div class="media-left">
                        <div class="avatar"><img src="{{ asset('vuexy/vuexy/app-assets/images/portrait/small/avatar-s-15.jpg') }}" alt="avatar" width="32" height="32"></div>
                      </div>
                    ...
                    <div class="media d-flex align-items-start">
                      <div class="media-left">
                        <div class="avatar"><img src="{{ asset('vuexy/vuexy/app-assets/images/portrait/small/avatar-s-3.jpg') }}" alt="avatar" width="32" height="32"></div>
                      </div>
                      <div class="media-body">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="user-nav d-sm-flex d-none">
                    {{-- <span class="user-name font-weight-bolder">{{ session('session_name') }}</span> --}}
                    <span class="user-name font-weight-bolder">{{ Auth::user()->name }}</span>
                    {{-- <span class="user-name font-weight-bolder">John Doe</span> --}}
                    <span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{ (asset('vuexy/vuexy/app-assets/images/portrait/small/avatar-s-11.jpg')) }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
