        ...
        <table class="user-list-table table">
          ...
          <tbody>
            ...
            <tr>
                ...
                {{-- <td><img src="{{ url('images/'.$row->file->image) }}" class="card-img-top" width="10" alt="..."></td> --}}
                <td>{{ $row->desc }}</td>
                <td>
...
<div class="modal fade text-left" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('contents-add') }}" class="form form-horizontal" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade text-left" id="edit-{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="{{ url('contents-update') }}" class="form form-horizontal" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                ...
                                @foreach ($row->file as $gambar)
                                    <input type="file" id="image" class="form-control" name="image" value="{{ $gambar->image }}" multiple>
                                @endforeach
                                {{-- <input type="file" id="image" class="form-control" name="image" value="{{ $row->file->image }}" multiple> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
